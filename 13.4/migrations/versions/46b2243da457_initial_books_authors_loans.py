"""initial: books authors loans

Revision ID: 46b2243da457
Revises: 
Create Date: 2026-06-20 23:26:51.429272
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('book_id', sa.Integer(), nullable=False),
    sa.Column('borrower', sa.String(length=200), nullable=False),
